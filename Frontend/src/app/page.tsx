...
import { Mic, Zap, Globe, Users, Star, ArrowRight, Play, Headphones, MessageSquare, BarChart3, Download } from 'lucide-react';
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            {[
              ...
              <ScrollReveal key={i} y={30} delay={i * 0.1}>
                <div className="rounded-2xl border border-gray-200 dark:border-gray-700 bg-white/80 dark:bg-gray-800/80 p-8 backdrop-blur-sm shadow-lg">
